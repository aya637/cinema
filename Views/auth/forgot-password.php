    ...
    <div class="cb-container">
        <div class="auth-card">
            ...
            <?php if (!empty($success)): ?>
                ...
                <a href="<?= BASE_URL ?>/public/index.php?url=login" class="btn btn-primary full-width">Back to Sign In</a>
            <?php else: ?>
                <?php if (!empty($errors)): ?>
                ...
                <form class="auth-form" method="post" action="<?= BASE_URL ?>/public/index.php?url=forgotPassword">
