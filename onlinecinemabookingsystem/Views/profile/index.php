    ...
    <div class="cb-container">
        ...
        <div class="profile-grid">
            ...
            <div class="profile-card side">
                ...
                <a href="<?= BASE_URL ?>/public/index.php?url=home" class="btn btn-secondary full-width">Back to homepage</a>
                        ...
                        <?php foreach ($currentBookings as $b): ?>
                            <li class="booking-item">
                                ...
                                <div class="booking-actions">
                                    <a href="<?= BASE_URL ?>/public/index.php?url=booking/<?= htmlspecialchars($b['id'] ?? '') ?>" class="btn btn-small btn-secondary">Manage</a>
                                </div>
                            </li>
                        <?php endforeach; ?>
                    </ul>
                    ...
                    <ul class="booking-list">
                        <?php foreach ($pastBookings as $b): ?>
                            <li class="booking-item">
                                ...
                                <div class="booking-actions">
                                    <a href="<?= BASE_URL ?>/public/index.php?url=receipt/<?= htmlspecialchars($b['id'] ?? '') ?>" class="btn btn-small btn-ghost">Receipt</a>
                                </div>
                            </li>
                        <?php endforeach; ?>
                    </ul>
