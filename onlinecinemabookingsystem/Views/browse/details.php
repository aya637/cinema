            ...
            <div class="cb-container">
                ...
                <div class="details-grid">
                    ...
                    <div class="poster-wrapper">
                        <?php 
                            $posterUrl = !empty($movie['poster']) ? $movie['poster'] : 'https://placehold.co/400x600/1f2937/ffffff?text=No+Poster';
                        ?>
                    ...
                    <div class="info-wrapper">
                        ...
                        <div class="meta-row">
                            <?php if(!empty($movie['rating'])): ?>
                                <div class="meta-badge"><span class="rating-star">★</span> <?= htmlspecialchars($movie['rating']) ?> / 10</div>
                            <?php endif; ?>
