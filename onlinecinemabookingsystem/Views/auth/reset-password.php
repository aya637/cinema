        ...
        <div class="auth-card">
            ...
            <?php if (!empty($errors)): ?>
                ...
                <div style="display: flex; gap: 0.75rem; margin-top: 1rem;">
                    <a href="<?= BASE_URL ?>/public/index.php?url=forgotPassword" class="btn btn-outline full-width">Request New Link</a>
                    <a href="<?= BASE_URL ?>/public/index.php?url=login" class="btn btn-ghost full-width">Back to Login</a>
                </div>
            <?php else: ?>
                <form class="auth-form" method="post" action="<?= BASE_URL ?>/public/index.php?url=resetPassword">
