...
// COMPLETE VERSION - All existing code + User booking history methods

class Booking extends Model {

    // ==========================================
    // USER BOOKING HISTORY METHODS (NEW)
    // ==========================================
    ...
    public function finalizeBooking($data) {
        try {
            ...
            // A. Check Availability One Last Time
            ...
            // C. Create Booking with status 'confirmed'
            $stmt = $this->db->prepare("
